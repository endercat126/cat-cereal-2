...
@export var food_values : Array[int]
...
@export var max_respawn_time := 0.8 # slow as fluff
@export var min_respawn_time := 0.3 # quick

@export var max_food_on_screen := 25 # sitting still will not make more food spawn
